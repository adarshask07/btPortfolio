...
const Contact: React.FC = () => {
  ...
  const handleButtonClick = () => {
    ...
    // Construct the WhatsApp link with name, email, and message
    const whatsappLink = `https://wa.me/8624940988?text=Name: ${encodeURIComponent(name)}%0AEmail: ${encodeURIComponent(email)}%0AMessage: ${encodeURIComponent(message)}`;
  ...
  const handleSubmit = (e) => {
    ...
    // Call the handleButtonClick function when the form is submitted
    handleButtonClick();
  };
